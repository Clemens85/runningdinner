...
8. Replace `spring-boot-starter-web` → `spring-boot-starter-webmvc`, add `spring-boot-starter-flyway`.
9. Upgrade `wiremock`, `logstash-logback-encoder`, `kryo`, `jakarta.mail`.
