...
@Component
public class RunningDinnerSettingsUpdatedActivityListener implements ApplicationListener<RunningDinnerSettingsUpdatedEvent>  {
  ...
  public void onApplicationEvent(RunningDinnerSettingsUpdatedEvent event) {
    ...
    activityService.createActivityForRunningDinnerSettingsUpdated(event);
  }
