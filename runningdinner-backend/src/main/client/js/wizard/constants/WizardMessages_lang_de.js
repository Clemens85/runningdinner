(function(angular) {
  'use strict';
    ...
    angular.module('rd.wizard.constants').constant('WizardMessages_lang_de', {
      ...
      team_distribution_help: 'Wenn aktiviert, wird automatisch versucht die Teams jeweils mit Teilnehmern die nicht genügend Platz haben und mit Teilnehmern die genügend Platz haben zu mischen',
      ...
      participants_preview_text: 'Mit den aktuellen Einstellungen benötigst du <strong>mindestens</strong>\n' +
          '<strong>{{ numParticipants }}</strong> Teilnehmer, damit du dein Dinner durchführen kannst.',
      participants_preview_demo_text: 'Bei Erstellung des Demo Dinner Events werden dir automatisch <strong>18</strong> Demo Teilnehmer angelegt, so dass du direkt und einfach alle\n' +
      ...
      wizard_demo_mode_text: 'Demo-Modus: Alle Einstellungen sind vorbelegt, können aber auch geändert werden.' +
                             '<br>Hinweis: Öffentliche Dinner werden im Demo-Modus nicht veröffentlicht.',
