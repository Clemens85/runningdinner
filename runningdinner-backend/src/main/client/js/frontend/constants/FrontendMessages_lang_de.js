(function(angular) {
  ...
  angular.module('rd.frontend.constants').constant('FrontendMessages_lang_de', {
    ...
    create_event_description: 'Erstelle kinderleicht dein eigenes (privates) Running Dinner Event - ganz ohne Registrierung!<br>' +
    ...
    discover_public_events_description: 'Finde öffentliche Running Dinner Events in deiner Nähe und melde dich unkompliziert hierfür an!\n' +
    ...
    public_events_no_event_found_description: 'Viele Veranstaltungen finden (halb-)privat statt.<br>' +
    ...
    privacy_question_description: 'Obwohl keine Registrierung oder Sonstiges erforderlich ist, ' +
