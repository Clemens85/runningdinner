...
export async function updateSelfAdminTeamHost(
  { selfAdminId, participantId, teamId }: SelfAdminTeamParams,
  updateTeamHostRequestData: SelfAdminUpdateTeamHostRequest,
): Promise<Team> {
