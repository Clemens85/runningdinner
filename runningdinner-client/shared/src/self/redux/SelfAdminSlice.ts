...
export const fetchSelfAdminTeam = createAsyncThunk('fetchSelfAdminTeam', async (selfAdminRequestParams: SelfAdminTeamParams) => {
  return await findSelfAdminTeam(selfAdminRequestParams);
});

export const fetchSelfAdminDinnerRoute = createAsyncThunk('fetchSelfAdminDinnerRoute', async (selfAdminRequestParams: SelfAdminTeamParams) => {
...
export const selfAdminSlice = createReducer(newInitialSelfAdminState(), (builder) => {
  builder
    .addCase(fetchSelfAdminSessionData.fulfilled, (state, action) => {
...
const getFetchDataItems = (state: SelfAdminStateType): FetchData<any>[] => {
  return [state.selfAdminSessionData, state.selfAdminTeam, state.selfAdminDinnerRoute];
};
