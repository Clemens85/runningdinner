const SelfAdminMessages_de: any = {
  change_team_host_title: 'Gastgeber verwalten',
  change_team_host_help:
    'Hier hast du die Möglichkeit dich oder deine(n) Team-Partner als neuen Gastgeber einzutragen. ' + 'Die Änderung wird sofort aktiv nachdem du sie gespeichert hast.',

  change_team_host_comment: 'Persönliche Bemerkungen',
  change_team_host_comment_help:
    'Dein Teampartner erhält eine automatische Benachrichtung wenn du den Gastgeber änderst. Hier kannst du noch eine persönliche Nachricht hinterlassen:',
  ...
  team_partner_wish_update_invalid:
    'Änderung deines Wunschpartners konnte nicht durchgeführt werden. ' +
  ...
  invalid_url:
    "Der von dir aufgerufene Link scheint nicht (mehr) gültig zu sein. Wende dich im Zweifel an den Organistaor deines Events oder an <anchor href='mailto:{{ adminEmail }}' title='{{ adminEmail }}' />",

  team_partner_wish_registration_change_teamhost_not_possible:
    'Da ihr euch als festes Koch-Team angemeldet habt und nur eine Adresse angegeben habt, könnt ihr keinen Gastgeber-Wechsel vornehmen. ' +
