const Wizard_en: any = {
  ...
  email_administration_link_help:
    'You will receive a message to this EMAil address containing a secret link to the administration area. ' +
  ...
  administration_link_help:
    'Please note down this link or save it to your favorites. Important: This link should NOT be shared with any other people due to it provides acccess to the administration area. ' +
  ...
  team_distribution_help:
    'Automatically try to build teams so that a team consists of one participant that cannot host and one participant that can host (due the number of seats is sufficient).',
  ...
  participants_preview_text:
    'With the current settings, you need at <strong>least</strong> <strong>{{ numParticipants }}</strong> participants for being able to run your dinner event.',
  participants_preview_demo_text:
    'The system will automatically create <strong>18</strong> demo participants for your demo event, so that you can easily start to test ' +
  ...
  adv_text_help:
    'As an event organizer you are responsible for the personal data of your participants in terms of data protection. Due to we cannot ensure that you ' +
  ...
  adv_text_address_help:
    'In order to be compliant with the Data Processing Terms, you have to enter your address data.<br>\n' +
  ...
  wizard_demo_mode_text:
    'Demo mode: All settings are preassigned, but you can change them.' + '<br /><strong>Note:</strong> Public dinner events will not be published in demo mode.',
