...
const SmallTitle = (props) => {
  return <TypographyWrapper {...props} variant={'subtitle2'} />;
};

const Title = (props) => {
  return <TypographyWrapper {...props} variant={'h6'} />;
};

const Subtitle = (props) => {
  return <TypographyWrapper {...props} variant={'h5'} />;
};

const Span = (props) => {
  return <TypographyWrapper {...props} variant={'body2'} />;
};
...
function TypographyWrapper(props) {
  ...
  if (props.html === true) {
    return (
      <Typography variant={variant} gutterBottom={gutterBottom} {...normalizedProps}>
        <HtmlTranslate i18n={i18n} parameters={parameters} ns={ns} />
      </Typography>
    );
  } else {
    return (
