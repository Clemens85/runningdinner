...
export function SwapMealsDialog({ srcTeam, adminId, onClose }: SwapMealsDialogProps) {
  ...
  const okButton = (
    <PrimarySuccessButtonAsync disabled={!selectedTeam} onClick={handleSwapMeal}>
      {t('admin:meals_swap')}
  ...
  return (
    <Dialog open={true} onClose={handleCancel} fullWidth={true}>
            ...
            <Paragraph>
              <Trans
                ...
                values={{
                  ...
                  newTeamNumber: getSelectedTeam(selectedTeam).teamNumber,
                }}
              />
            </Paragraph>
            <br />
      ...
      <DialogActions>
        <DialogActionsButtons okButton={okButton} cancelButton={<DefaultDialogCancelButton onCancel={handleCancel} cancelLabel={t('common:cancel')} />} />
      </DialogActions>
    </Dialog>
  );
}
