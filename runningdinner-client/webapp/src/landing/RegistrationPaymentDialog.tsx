...
export function RegistrationPaymentDialog({ onCancel, registrationDataCollection, publicRunningDinner }: RegistrationPaymentDialogProps) {
  ...
  return (
    <Dialog onClose={onCancel} open={true}>
      ...
      <DialogContent>
        <Paragraph>
          <Trans i18nKey={'landing:registration_payment_info'} />
        </Paragraph>
        ...
        <Grid container sx={{ my: 3 }}>
          <Grid item xs={12}>
            <Card>
              ...
              <CardContent>
                ...
                <PaymentCardList>
                  <Typography component="li" variant="subtitle1" align="center">
                    {t('common:organizer')}: {registrationPaymentSummary.brandName}
                  </Typography>
                  <Typography component="li" variant="subtitle1" align="center">
                  ...
                  <Typography component="li" variant="subtitle1" align="center">
                    {t('landing:payment_check_contact_data')}:
                  </Typography>
                  <Typography component="li" variant="subtitle1" align="center">
                  ...
                  {isStringNotEmpty(registrationData.mobileNumber) && (
                    <Typography component="li" variant="subtitle1" align="center">
                      <strong>{registrationData.mobileNumber}</strong>
                    </Typography>
                  )}
                  {isStringNotEmpty(registrationPaymentSummary.agbLink) && (
                    <Typography component="li" variant="subtitle1" align="center">
                      <LinkExtern href={registrationPaymentSummary.agbLink} self={false}>
              ...
              <CardActions>
                <PrimaryButton disabled={orderProcessing} size={'large'} fullWidth onClick={handleCreateOrder}>
                  {t('landing:payment_purchase_now')}
                </PrimaryButton>
              </CardActions>
            </Card>
          </Grid>
