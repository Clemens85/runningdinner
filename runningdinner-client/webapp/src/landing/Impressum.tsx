    ...
    <>
      ...
      <div>
        <div>
          ...
          Diese Website dient ausschließlich als Plattform zur Organisation von Koch-Events.
          Die Durchführung von Koch-Events obliegt alleinig den jeweiligen Veranstaltern.<br />
      ...
      <div>
        <div>
          ...
          Die offizielle Datenschutzerklärung befindet sich im nächsten Abschnitt.<br />
          ...
          <ul>
            ...
            <li>Sinn und Zweck dieser Plattform ist die Durchführung von gemeinsamen Koch-Events mit mehreren Teilnehmern aufgeteilt in verschiedene Teams
              die sich gegenseitig besuchen
              <ul>
                <li>Um diese Events durchführen und organisieren zu können müssen offensichtlich personenbezogene Daten der einzelnen Teilnehmer erhoben werden.
                  Es werden nur solche Daten als Pflicht-Eingaben gespeichert die zur Durchführung absolut notwendig sind.</li>
              </ul>
            </li>

            <li><strong>Die Betreiber dieser Plattform organisieren selbst keine Koch-Events, sondern bieten lediglich eine Plattform zur Veranstaltung solcher Koch-Events an.
              Daher obliegt die Verantwortung für den Umgang mit den erhobenen Daten beim Veranstalter eines solchen Events (siehe auch &nbsp;
              <a href={advUrl} target="_blank" rel="noreferrer">Vereinbarung zur Auftragsdatenverarbeitung</a>).</strong></li>

            <li>Alle gespeicherten Daten werden vom Betreiber dieser Plattform <strong>ausschliesslich</strong> zur Durchführung dieser Events gespeichert und nach Abschluss
              der Events (nach max. 7 Tagen) automatisch wieder vollständig gelöscht.
              Eine weitere Verwendung dieser Daten findet <strong>nicht</strong> statt.</li>

            <li>Es werden keine kommerziellen Zwecke mit dieser Plattform verfolgt. Es findet weder eine Datenweitergabe noch eine Auswertung der Daten zu Werbezwecken
              o.Ä. statt.</li>

            <li>Außer Google Maps (zur Darstellung der Koch-Routen) werden keinerlei 3rd Party Anwendungen eingebunden.
              So gibt es auf dieser Plattform auch <strong>kein</strong> Google Analytics o.Ä.</li>
          </ul>
          (Stand: 20. April 2019)
        </div>
      </div>
      ...
      <div>
        <div>
          ...
          <p>Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) im Rahmen der
            Erbringung unserer Leistungen sowie innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie
          ...
          <p>„Personenbezogene Daten“ sind alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person (im Folgenden „betroffene Person“) beziehen;
            ...
            physischen, physiologischen, genetischen, psychischen, wirtschaftlichen, kulturellen oder sozialen Identität dieser natürlichen Person sind.<br />
            <br />
            ...
            Mittel der Verarbeitung von personenbezogenen Daten entscheidet, bezeichnet.<br />
            <br />
          ...
          <p>Nach Maßgabe des Art. 13 DSGVO teilen wir Ihnen die Rechtsgrundlagen unserer Datenverarbeitungen mit. Für Nutzer aus dem Geltungsbereich der Datenschutzgrundverordnung
          ...
          <p>Wir treffen nach Maßgabe der gesetzlichen Vorgabenunter Berücksichtigung des Stands der Technik, der Implementierungskosten und der Art, des Umfangs, der Umstände und
            ...
            geeignete technische und organisatorische Maßnahmen, um ein dem Risiko angemessenes Schutzniveau zu gewährleisten.<br />
            <br />
          ...
          <p>Sofern wir im Rahmen unserer Verarbeitung Daten gegenüber anderen Personen und Unternehmen (Auftragsverarbeitern, gemeinsam Verantwortlichen oder Dritten) offenbaren,
          ...
          <p>Sofern wir Daten in einem Drittland (d.h. außerhalb der Europäischen Union (EU), des Europäischen Wirtschaftsraums (EWR) oder der Schweizer Eidgenossenschaft)
            ...
            verbindlichen internen Datenschutzvorschriften verarbeiten (Art. 44 bis 49 DSGVO, <a
              href="https://ec.europa.eu/info/law/law-topic/data-protection/data-transfers-outside-eu_de" target="blank">Informationsseite der EU-Kommission</a>).</p>
          <Subtitle id="dsg-general-rightssubject">Rechte der betroffenen Personen</Subtitle>
          <p>Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob betreffende Daten verarbeitet werden und auf Auskunft über diese Daten sowie auf weitere Informationen
            und Kopie der Daten entsprechend den gesetzlichen Vorgaben.<br />
            <br />
          ...
          <p><strong>Sie können der künftigen Verarbeitung der Sie betreffenden Daten nach Maßgabe der gesetzlichen Vorgaben jederzeit widersprechen. Der Widerspruch kann
          ...
          <p>Als „Cookies“ werden kleine Dateien bezeichnet, die auf Rechnern der Nutzer gespeichert werden. Innerhalb der Cookies können unterschiedliche Angaben gespeichert
            ...
            Trackings, über die US-amerikanische Seite <a href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</a> oder die EU-Seite <a
          ...
          <p>Die von uns verarbeiteten Daten werden nach Maßgabe der gesetzlichen Vorgaben gelöscht oder in ihrer Verarbeitung eingeschränkt. Sofern nicht im Rahmen dieser
            ...
            werden gesperrt und nicht für andere Zwecke verarbeitet. Das gilt z.B. für Daten, die aus handels- oder steuerrechtlichen Gründen aufbewahrt werden müssen.</p>
          <Subtitle id="dsg-general-changes">Änderungen und Aktualisierungen der Datenschutzerklärung</Subtitle>
          <p>Wir bitten Sie sich regelmäßig über den Inhalt unserer Datenschutzerklärung zu informieren. Wir passen die Datenschutzerklärung an, sobald die Änderungen der von uns
          ...
          <p></p>
          <p><span>Bei der Kontaktaufnahme mit uns (z.B. per Kontaktformular, E-Mail, Telefon oder via sozialer Medien) werden die Angaben des Nutzers zur Bearbeitung der Kontaktanfrage und deren Abwicklung gem. Art. 6 Abs. 1 lit. b. (im Rahmen vertraglicher-/vorvertraglicher Beziehungen),  Art. 6 Abs. 1 lit. f. (andere Anfragen) DSGVO verarbeitet.. Die Angaben der Nutzer können in einem Customer-Relationship-Management System ("CRM System") oder vergleichbarer Anfragenorganisation gespeichert werden.<br />
            <br />
          ...
          <p><span>Wir binden die Landkarten des Dienstes “Google Maps” des Anbieters Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Zu den verarbeiteten Daten können insbesondere IP-Adressen und Standortdaten der Nutzer gehören, die jedoch nicht ohne deren Einwilligung (im Regelfall im Rahmen der Einstellungen ihrer Mobilgeräte vollzogen), erhoben werden. Die Daten können in den USA verarbeitet werden. Datenschutzerklärung: <a
            target="_blank" href="https://www.google.com/policies/privacy/" rel="nofollow noreferrer">https://www.google.com/policies/privacy/</a>, Opt-Out: <a target="_blank"
              href="https://adssettings.google.com/authenticated" rel="nofollow noreferrer">https://adssettings.google.com/authenticated</a>.</span>

          </p>

          <p style={{ fontWeight: "lighter" }}>
            Vom Betreiber der Website angepasst<br />
            <a href="https://datenschutz-generator.de" rel="nofollow noreferrer" target="_blank">Erstellt mit Datenschutz-Generator.de von RA Dr. Thomas Schwenke</a>
          </p>
