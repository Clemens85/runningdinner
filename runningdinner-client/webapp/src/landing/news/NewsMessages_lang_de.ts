const NewsMessages_de: any = {
  ...
  news_content_20251207:
    ...
    'Natürlich sollte so etwas nie passieren. Dieser Fehler ist nun behoben und sollte bei der Optimierung nicht mehr auftreten.',
  ...
  news_content_20240624:
    'Die Dinner Routen wurden verbessert: Es gibt nun eine neue Ansicht, welche alle Gastgeber und deren Route in einer Karte anzeigt. ' +
  ...
  news_content_20231126:
    'Es konnte die letzten Tage im Zusammenhang mit der Möglichkeit der Sofort-Anmeldung von Wunschpartern zu Fehlern kommen, ' +
  ...
  news_content_20231118:
    'Es ist jetzt möglich die Speisen zwischen einzelnen Teams zu tauschen. Einfach auf die "..." neben dem ausgewählten Team klicken und dort "Speise tauschen" wählen.',

  news_title_20231108: 'Reihenfolge von Teilnehmern tauschen + kleiner Bugfix',
  news_content_20231108:
    'Ab und zu kann es vorkommen, dass man Teilnehmer von bzw. auf die Warteliste schieben will. ' +
  ...
  news_content_20231013:
    'Heute wurden einige grundlegende technologische Updates eingespielt. Natürlich wurde alles gründlichst getestet, ' +
  ...
  news_content_20230619:
    'Es ist schon länger möglich über einen Einladungsprozess per Email einen festen Wunschpartner quasi mit anzugeben, welche/r sich aber dann dennoch mit sämtlichen Daten selbst anmelden musste. ' +
  ...
  news_content_20230418:
    'Auch das muss mal sein: Die zugrunde liegende Infrastruktur musste neu und moderner aufgesetzt werden, was ein längerer Prozess war, der nun aber fertig ist. ' +
  ...
  news_title_20230417: 'After-Event-Party hinzugefügt',
  news_content_20230417:
    'Öfters nachgefragt, nun verfügbar: Bei Erstellung eines Events (oder nachträglich in den Einstellungen) kann der Ort einer After-Event-Party hinzugefügt werden. ' +
  ...
  news_content_20221029:
    'Leider gab es einen Fehler der beim Versand der Einladungs EMails an potenzielle Team-Partner auftrat ' +
  ...
  news_content_20220712:
    'Immer wieder angefragt, nun endlich verfügbar: Es gibt im Veranstaltungs-Admin-Bereich eine neue Funktion zur Wartelisten Verwaltung, ' +
  ...
  news_content_20220413:
    'Falls ihr euch gewundert habt warum eure Event-Beschreibung so komisch aussah (d.h. keine Absätze angezeigt wurden): ' +
  ...
  news_content_20220313:
    'Oft angefragt, nun endlich verfügbar: ' +
  ...
  news_content_20220312:
    'Wie ihr vielleicht schon bemerkt habt, wurde die gesamte Benutzeroberfläche neu implementiert. ' +
  ...
  news_content_20201001:
    'Durch einen technischen Fehler im Running Dinner Tool kam es in letzter Zeit leider vereinzelt zu Problemen bei der Durchführung der Team Einteilungen. Dieser Fehler ist mittelerweile behoben. ' +
    ' Zusätzlich wurden weitere kleinere Verbesserungen durchgeführt.',

  news_title_20200205: 'Fehler behoben bei Anmeldung',
  news_content_20200205:
    'Durch einen technischen Fehler im Running Dinner Tool kam es in letzter Zeit leider vereinzelt zu Problemen bei der Anmeldung. Dieser Fehler ist mittelerweile behoben ' +
    'und die Anmeldungen funktionieren wieder wie gewohnt.',

  news_title_20191011: 'Fehler behoben bei Essens-Wünschen',
  news_content_20191011:
    'Es gab leider einen Fehler in der Software, bei welchem die Essens-Wünsche von Teilnehmern nicht korrekt in den Dinner Routen ' +
    'wiedergegeben wurden. Dieser Fehler ist mittlerweile behoben und die angegebenen Essens-Wünsche (wie z.B. vegetarisch) ' +
    'werden korrekt angezeigt.',

  news_title_20190701: 'Mehrsprachigkeit',
  news_content_20190701:
    'Die Webanwendung wurde erweitert, so dass mittlerweile auch Englisch als Sprache unterstützt wird. ' +
    'D.h. man kann die Plattform nun auch auf Englisch durchstöbern bzw. können Veranstaltungen nun auch in englischer Sprache erstellt werden, ' +
    'was insbesondere im nicht deutsch-sprachigem Raum interessant ist bzw. auch sinnvoll sein kann wenn viele Teilnehmer kein Deutsch sprechen.',

  news_title_20190620: 'Neuigkeiten',
  news_content_20190620: 'Hier werden wir euch von Zeit zu Zeit darüber informieren was es so an Neuigkeiten / Weiterentwicklungen ' + 'auf der Running Dinner Plattform gibt.',

  x: '',
};
export default NewsMessages_de;
